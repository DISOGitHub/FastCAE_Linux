...
#      define VTKDICOMPARSER_EXPORT __attribute__((visibility("default")))
#    else
...
#    define VTKDICOMPARSER_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef VTKDICOMPARSER_DEPRECATED
#  define VTKDICOMPARSER_DEPRECATED __attribute__ ((__deprecated__))
#endif
