...
bool ReadData_Cgns::ReadGridCooridate(int file_index, int base_index, int zone_index, int vertext_num, /*int*/cgsize_t range_from[3], /*int*/cgsize_t range_to[3], int & cooridateNum, MG_CGNS_Points & pts)
{
