...
namespace FastCAEDesigner
{
	...
	void ParaBasicSetup::Init()
	{
		...
		//_styleOk = QString("QLineEdit {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px; background-color:white; selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}QLineEdit:!enabled {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px;  background-color: rgb(216,216,216); selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}");//背景色
		//_styleError = QString("QLineEdit {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px; background-color:red; selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(225,225,225);}QLineEdit:!enabled {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px;  background-color: rgb(216,216,216); selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}");//背景色
		_styleOk = QString("QLineEdit {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px; background-color:white; selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}QLineEdit:!enabled {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px;  background-color: rgb(216,216,216); selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}");//背景色
		_styleError = QString("QLineEdit {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px; background-color:red; selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(225,225,225);}QLineEdit:!enabled {border-width: 1px;padding: 1px; border-style: solid;border-color: #e1e1e1;border-radius:1px;  background-color: rgb(216,216,216); selection-color: #0a214c;selection-background-color: #C19A6B;min-height:24px; color:rgb(126,126,126);}");//背景色
	}
