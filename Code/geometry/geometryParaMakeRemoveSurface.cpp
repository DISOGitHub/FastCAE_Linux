...
namespace Geometry
{
	GeometryParaMakeRemoveSurface::GeometryParaMakeRemoveSurface()
	{
		_type = GeometryParaRemoveSurface;
	}

	void GeometryParaMakeRemoveSurface::setName(QString name)
	{
		_name = name;
	}

	QString GeometryParaMakeRemoveSurface::getName()
	{
		return _name;
	}

	void GeometryParaMakeRemoveSurface::setInputSet(GeometrySet* s)
	{
		_geoSet = s;
	}
	
	GeometrySet* GeometryParaMakeRemoveSurface::getGeometrySet()
	{
		return _geoSet;
	}
	
	void GeometryParaMakeRemoveSurface::setFaceList(QList<int> edgeList)
	{
		_faceIndexList = edgeList;
	}
	
	QList<int> GeometryParaMakeRemoveSurface::getFaceList()
	{
	...
	void GeometryParaMakeRemoveSurface::readDataFromProjectFile(QDomElement* e)
	{
