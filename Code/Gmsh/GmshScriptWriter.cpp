...
// 		}
	...
	void GmshScriptWriter::writeSolidFrustumScript(QTextStream* out, QStringList list, int& index)
	{
		const int n = list.size();
		if (n != 15)return;
		...
		double xa = val[8]; double ya = val[9]; double za = val[10];
		...
		*out << "//+" << endl << QString("Field[%1] = Frustum;").arg(index) << endl;
		*out << "//+" << endl << QString("Field[%1].R1_inner = %2;").arg(index).arg(val[0]) << endl;
		*out << "//+" << endl << QString("Field[%1].R2_inner = %2;").arg(index).arg(val[2]) << endl;
		*out << "//+" << endl << QString("Field[%1].V1_inner = %2;").arg(index).arg(val[11]) << endl;
		*out << "//+" << endl << QString("Field[%1].V2_inner = %2;").arg(index).arg(val[11]) << endl;
		*out << "//+" << endl << QString("Field[%1].R1_outer = %2;").arg(index).arg(val[1]) << endl;
		*out << "//+" << endl << QString("Field[%1].R2_outer = %2;").arg(index).arg(val[3]) << endl;
		*out << "//+" << endl << QString("Field[%1].V1_outer = %2;").arg(index).arg(val[12]) << endl;
		*out << "//+" << endl << QString("Field[%1].V2_outer = %2;").arg(index).arg(val[12]) << endl;
		*out << "//+" << endl << QString("Field[%1].X1 = %2;").arg(index).arg(val[5]) << endl;
		*out << "//+" << endl << QString("Field[%1].X2 = %2;").arg(index).arg(val[8]) << endl;
		*out << "//+" << endl << QString("Field[%1].Y1 = %2;").arg(index).arg(val[6]) << endl;
		*out << "//+" << endl << QString("Field[%1].Y2 = %2;").arg(index).arg(val[9]) << endl;
		*out << "//+" << endl << QString("Field[%1].Z1 = %2;").arg(index).arg(val[7]) << endl;
		*out << "//+" << endl << QString("Field[%1].Z2 = %2;").arg(index).arg(val[10]) << endl;
