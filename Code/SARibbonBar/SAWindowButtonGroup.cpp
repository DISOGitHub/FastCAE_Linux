...
public:
    ...
    void setupMinimizeButton(bool on)
    {
        ...
        if (on) {
			...
			QIcon icon;
			icon.addFile(QString::fromUtf8(":/image/resource/minimize.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void setupCloseButton(bool on)
    {
        ...
        if (on) {
            ...
            buttonClose->setStyleSheet(QString(""
                ...
                "SAWindowToolButton:focus{outline: none;}"));
			QIcon icon;
			icon.addFile(QString::fromUtf8(":/image/resource/close.png"), QSize(), QIcon::Normal, QIcon::Off);
...
void SAWindowButtonGroup::setWindowStates(Qt::WindowStates s)
{
    ...
    case Qt::WindowNoState:
        if (m_d->buttonMaximize) {
			...
			m_d->buttonMaximize->setToolTip(QCoreApplication::translate("SAWindowButtonGroup", "Maximize", nullptr));
		}
        break;

    case Qt::WindowMaximized:
        if (m_d->buttonMaximize) {
			icon.addFile(QString::fromUtf8(":/image/resource/maximize.png"), QSize(), QIcon::Normal, QIcon::Off);
			m_d->buttonMaximize->setIcon(icon);
			m_d->buttonMaximize->setToolTip(QCoreApplication::translate("SAWindowButtonGroup", "Reducing Down", nullptr));
		}
        break;
	...
	m_d->buttonMinimize->setToolTip(QCoreApplication::translate("SAWindowButtonGroup", "Minimize", nullptr));
	m_d->buttonClose->setToolTip(QCoreApplication::translate("SAWindowButtonGroup", "Close", nullptr));
}
