...
namespace MeshData
{
	CgnsReader::CgnsReader(const QString &filename)
	{
		_filename = filename;
...
//		return false;
	...
	bool CgnsReader::readZone(int file_index, int base_index, int zone_index)
	{
//#ifdef Q_OS_WIN
...
// 		return false;
	...
	bool CgnsReader::readStructuredZone(int file_index, int base_index, int zone_index)
	{
//#ifdef Q_OS_WIN
		char zone_name[33] = { 0 };
		int zone_ijk[3][3] = { 0 };
...
// 		return false;
	...
	bool CgnsReader::readBC(int file_index, int base_index, int zone_index, int zonei, int zonej, int zonek, MeshKernal* kernal)
	{
//#ifdef Q_OS_WIN
		int nbocos = 0;
...
// 		return false;
	...
	bool CgnsReader::readUnStructuredZone(int file_index, int base_index, int zone_index)
	{
//#ifdef Q_OS_WIN
		char zone_name[33] = { 0 };
		int zone_ijk[3][3] = { 0 };
...
// 		return false;
	...
	void CgnsReader::readCoordinate(int file_index, int base_index, int zone_index, int vertext_num,
...
//#endif
	...
	void CgnsReader::readSections(int file_index, int base_index, int zone_index, MeshKernal* kernal)
	{
//#ifdef Q_OS_WIN
...
//#endif
	...
	void CgnsReader::readCells(int start_index, int end_index, int type, int* elements, int element_data_size, MeshKernal* kernal)
	{
//#ifdef Q_OS_WIN
		vtkDataSet* dataset = kernal->getMeshData();
		vtkUnstructuredGrid* ungird = dynamic_cast<vtkUnstructuredGrid*>(dataset);
